...
<summary>week 1</summary>
  <table>
    ...
    <tr>
      ...
      <td>keywords...</td>
      <td>
        아, 근데 사실 왜 비동기로 처리하는게 좋은건지.. 제대로 이해를 못하고 있다. 채팅 서버 구현이 아닌, Architecture의 Reference를 다시 찾아보자..
        -> 아! 비동기 처리는 필수네?, Tomcat + 웹소켓방식해도 메시지 지향 미들웨어(MOM, 메시지 큐!)를 사용하는구나..
        -> 그럼, 네트워크 레벨은 Netty의 도움을 받아서 좀 더 빠르게 진행하자.
      </td>
      <td>
